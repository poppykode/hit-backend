"""
Django settings for my_hit_backend project.
...
SECRET_KEY = 'gp_py+741w-4#!da#+h86*jyf_v3#&v-!-0*x%hs)+gcc)_(pm'
...
ROOT_URLCONF = 'my_hit_backend.urls'
...
WSGI_APPLICATION = 'my_hit_backend.wsgi.application'
